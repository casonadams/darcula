...
call s:Hi('GitDeleteStripe', s:p.deleteStripe)
...
call s:Hi('ErrorSign', s:p.errorStripe)
call s:Hi('WarningSign', s:p.warnStripe)
call s:Hi('InfoSign', s:p.infoStripe)
call s:Hi('HintSign', s:p.hintStripe)
