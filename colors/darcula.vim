...
let s:darcula_grey0_gui = "#BBBBBB"
let s:darcula_grey0_cterm = 250

let s:p={
      \ 'null': ['NONE', 'NONE'],
      \ 'bg': [s:darcula_bg_gui, s:darcula_bg_cterm],
      \ 'fg': [s:darcula_fg_gui, s:darcula_fg_cterm],
      \ 'cursor': [s:darcula_grey0_gui, s:darcula_grey0_cterm],
      ...
      \ 'muted': ['#606060', 241],
      \ 'link': ['#287BDE', 32],
      \ 'stdOutput': [s:darcula_grey0_gui, s:darcula_grey0_cterm],
      ...
      \ 'typeDef': ['#B9BCD1', 146],
      \ 'menu': ['#46484A', 238],
      \ 'menuFg': [s:darcula_grey0_gui, s:darcula_grey0_cterm],
      \ 'menuSel': ['#113A5C', 23],
      \ 'menuSBar': ['#616263', 241],
      \ 'tag': ['#E8BF6A', 180],
      \ 'entity': ['#6D9CBE', 109],
      ...
      \ 'statusLineFg': [s:darcula_grey0_gui, s:darcula_grey0_cterm],
      ...
      \ 'ANSIRed': ['#B34B49', 131],
      \ 'ANSIGreen': ['#548C26', 64],
      \ 'ANSIYellow': ['#8A7924', 100],
      \ 'ANSIBlue': ['#3A91CF', 68],
      \ 'ANSIMagenta': ['#E55CE5', 170],
      \ 'ANSICyan': ['#009191', 30],
      \ 'ANSIGray': ['#7A7A7A', 243],
