...
call s:Hi('SignifySignAdd', s:p.addStripe, s:p.addStripe)
call s:Hi('SignifySignChange', s:p.changeStripe, s:p.changeStripe)
call s:Hi('SignifySignDelete', s:p.deleteStripe, s:p.gutter)
